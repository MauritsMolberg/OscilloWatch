    ...
    return {
        ...
        'gov': {
            'TGOV1': [
                ...
                ['GOV3', 'G3', 0.05, 0.02, 0, 2, 0.1, 0.09, 0.2],
                ['GOV4', 'G4', 0.05, 0.02, 0, 2, 0.1, 0.09, 0.2],
            ],
            'HYGOV': [
                ['name', 'gen', 'R', 'r', 'T_f', 'T_r', 'T_g', 'A_t', 'T_w', 'q_nl', 'D_turb', 'G_min', 'V_elm',
                 'G_max', 'P_N'],
                ['HYGOV1', 'G1', 0.06, 0.5, 0.05, 10, 0.2, 1, 1, 0.01, 0.01, 0.0, 100, 2, 0],
                ['HYGOV2', 'G2', 0.06, 0.5, 0.05, 10, 0.2, 1, 1, 0.01, 0.01, 0.0, 100, 2, 0],
            ],
        },
        ...
        'avr': {
            ...
            #    ['AVR1', 'G1', 300, 1, 1, 0.1, -3, 6],
            #    ['AVR2', 'G2', 300, 1, 1, 0.1, -3, 6],
            #    ['AVR3', 'G3', 300, 1, 1, 0.1, -3, 6],
            #    ['AVR4', 'G4', 300, 1, 1, 0.1, -3, 6],
            #]

            #'SEXS': [
            #    ['name', 'gen', 'K', 'T_a', 'T_b', 'T_e', 'E_min', 'E_max'],
            #    ['AVR1', 'G1', 400, 0.5, 3.0, 0.1, -3, 6],
            #    ['AVR2', 'G2', 400, 0.5, 3.0, 0.1, -3, 6],
            #    ['AVR3', 'G3', 400, 0.5, 3.0, 0.1, -3, 6],
            #    ['AVR4', 'G4', 400, 0.5, 3.0, 0.1, -3, 6],
            #]

            'SEXS_PI': [
                ['name',    'gen',  'K_p',  'K_i',  'K',    'T_a',   'T_b',  'T_e',  'T_ext',    'E_min',    'E_max'],
                ['AVR1',    'G1',   100,    400,     1,      1,       1,      0.1,    0.05,        -3,         6],
                ['AVR2',    'G2',   100,    400,     1,      1,       1,      0.1,    0.05,        -3,         6],
                ['AVR3',    'G3',   100,    400,     1,      1,       1,      0.1,    0.05,        -3,         6],
                ['AVR4',    'G4',   100,    400,     1,      1,       1,      0.1,    0.05,        -3,         6],
            ]
        },

        'pss': {
            'STAB1': [
                #T3/4 in formula from slide -> T1/2 here
